...
Players alternate turns and can only place a piece if it sandwiches at least one opponent piece between their new piece and another of their own.
...
Colored and formatted output using ANSI escape sequences for improved console experience.
...
1 to pass your turn if no valid moves are available.
...
Team Members: Nishu Verma, Sarah Fatima, Reshma Maurya